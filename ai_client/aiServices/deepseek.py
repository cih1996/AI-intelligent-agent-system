...
class DeepSeekClient:
    ...
    def chat(
        ...
        **kwargs
        ...
        :param history_messages: 外部传入的历史对话记录（可选）
    ...
    def chat_with_image(
        ...
        **kwargs
        ...
        :param use_history: 是否使用历史对话记录（DeepSeek 不支持）
        :param history_messages: 外部传入的历史对话记录（DeepSeek 不支持）
    ...
    def add_to_history(self, role, content):
        ...
        print(f"[DeepSeek] 已添加 {role} 消息到历史记录")
